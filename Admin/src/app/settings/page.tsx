...
const Settings = () => {
  ...
  const handleSaveChanges = async (e: any) => {
    e.preventDefault();
    if (!images[0] || !name || !email || !phone || !whatsapp) {
                        ...
                        >
                          <g opacity="0.8">
                            <path
                              fillRule="evenodd"
                              clipRule="evenodd"
                              d="M15.625 14.1667C14.5833 14.1667 13.5833 13.95 12.675 13.5417C12.4083 13.4167 12.0917 13.4917 11.8833 13.7L10.5 15.0833C7.25833 13.3667 5.00833 11.1167 3.29167 7.875L4.675 6.49167C4.88333 6.28333 4.95833 5.96667 4.83333 5.7C4.425 4.79167 4.20833 3.79167 4.20833 2.75C4.20833 2.20833 3.79167 1.79167 3.25 1.79167H1.45833C0.916667 1.79167 0.5 2.20833 0.5 2.75C0.5 6.68333 2.13333 10.2417 4.80833 12.9167C7.48333 15.5917 11.0417 17.225 14.975 17.225C15.5167 17.225 15.9333 16.8083 15.9333 16.2667V14.475C15.9333 13.9333 15.5167 13.5167 14.975 13.5167H 15.625Z"
                              fill=""
                            />
                          </g>
                        </svg>
